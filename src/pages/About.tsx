  ...
  <Layout>
    <section className="py-16 lg:py-24">
      <div className="container mx-auto px-4 lg:px-8">
        <SectionHeading label="About Us" title="Passion Meets Precision" />
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          >
            <img src={heroImg} alt="Monterey Bay PCs workshop" loading="lazy" width={1920} height={1080} className="rounded-xl rgb-glow w-full" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <p className="text-muted-foreground mb-4">
              Based in the beautiful Monterey Bay area of California, we combine our passion for technology with an obsessive attention to detail. Every cable is routed, every thermal pad is placed, and every system is stress-tested before it leaves our hands.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              {[
                ...
                <div key={s.label} className="text-center">
                  <span className="font-display text-2xl font-bold gradient-rgb-text block">{s.value}</span>
